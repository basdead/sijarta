...
from MyPay.models import Pengguna
from PekerjaanJasa.models import Job

class MyPayTransaction(models.Model):
    guest = models.ForeignKey(Pengguna, on_delete=models.CASCADE, related_name='mypay_transactions_transaksi')  # related_name ditambahkan
    ...
    destination_phone = models.CharField(max_length=15, blank=True, null=True)
