...
SECRET_KEY = 'django-insecure-!!^#6b_#72%%5obgeh9m9e+^uit4%-u651prkcg#vj^e4u+=$i'
...
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')  # This is where collectstatic will collect files for production
